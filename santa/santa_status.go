...
func santaStatusColumns() []table.ColumnDefinition {
...
func santaStatusTablePlugin() *table.Plugin {
	return table.NewPlugin("santa_status", santaStatusColumns(), santaStatusGenerate)
}
